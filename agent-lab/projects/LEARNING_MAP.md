...
```bash
cd agent-lab/projects/structured_output_demo
...
```bash
cd agent-lab/projects/workflow_agent
...
```bash
cd agent-lab/projects/tool_agent_demo
...
```bash
cd agent-lab/projects/doc_qa_agent
