import { traceCall, traceEvent, useLearningLifecycle, useLearningState } from '../../learning'

export default function Counter() {
  useLearningLifecycle('Counter')

  // 这是一个最小测试组件：
  // 只保留一个按钮和一个状态，方便测试文件专注验证“点击后值会不会变化”。
  // 组件越小，测试目标就越明确，也越适合初学者理解。
  const [count, setCount] = useLearningState('Counter', 'count', 0)
