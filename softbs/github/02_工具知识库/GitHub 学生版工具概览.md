...
> 目标：把 GitHub Student Developer Pack 当作“免费资源入口”，再结合 [GitHub 工具学习地图](./github网站工具推荐_优化完整版.md)里的开源项目，建立一个以后可以持续查阅的学习工具库。
...
- 工具目录：[github网站工具推荐_优化完整版.md](./github网站工具推荐_优化完整版.md)负责整理“GitHub 上值得学习、查阅、使用的先进项目和工具”。
...
具体工具清单统一维护在：
- [GitHub 工具学习地图](./github网站工具推荐_优化完整版.md)
...
以后看到新的 GitHub 工具，可以按这个模板追加到 [GitHub 工具学习地图](./github网站工具推荐_优化完整版.md)：
...
6. 从 [GitHub 工具学习地图](./github网站工具推荐_优化完整版.md)选择一个先进工具，阅读 README 并在本地运行。
