...
- 本示例对纯文本直接使用 TextLoader 加载 rag.txt，再用 RecursiveCharacterTextSplitter 切分；这样比 unstructured 更稳，也更适合入门。
...
TXT_PATH = BASE_DIR / "rag.txt"
documents = TextLoader(str(TXT_PATH), encoding="utf-8").load()
