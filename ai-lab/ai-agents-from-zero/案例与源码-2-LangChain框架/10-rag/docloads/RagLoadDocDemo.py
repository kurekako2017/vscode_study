...
# pip install langchain_community unstructured[docx] python-docx docx2txt
...
DOCX_PATH = BASE_DIR / "assets" / "alibaba-more.docx"
...
try:
    ...
    print(f"Word 专用加载器不可用，回退到 Docx2txtLoader：{e}")
