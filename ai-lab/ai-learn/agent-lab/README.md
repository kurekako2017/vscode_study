...
```bash
python3 ai-learn/agent-lab/projects/chat_cli/main.py --mock "用一句话解释 Tool Calling"
python3 ai-learn/agent-lab/projects/tool_agent_demo/main.py --mock --workdir ai-lab "概览这个目录"
python3 ai-learn/agent-lab/projects/workflow_agent/main.py --mock "规划一个 RAG PoC"
```
