...
如果你是从 `llm-lab` 进入的学习者，也会复用这里的 demo；`llm-lab/README.md` 只做主线索引，不重复维护运行说明。
...
```powershell
cd ai-learn/agent-lab/projects/demo_name
.\run_demo.ps1
```
...
1. [chat_cli](chat_cli/README.md)
2. [structured_output_demo](structured_output_demo/README.md)
3. [doc_qa_agent](doc_qa_agent/README.md)
4. [rag_api_demo](rag_api_demo/README.md)
5. [tool_agent_demo](tool_agent_demo/README.md)
6. [workflow_agent](workflow_agent/README.md)
...
新增：[streaming_agent_api_demo](./streaming_agent_api_demo/README.md) 提供 SSE `status/token/error/done` 服务化模板。
