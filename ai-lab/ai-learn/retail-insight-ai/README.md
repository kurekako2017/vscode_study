...
- 该脚本会把同步块写入双方文档末尾，不覆盖各自正文。
- 同步范围由 [doc-sync.manifest.json](../doc-sync.manifest.json) 统一管理。
- 当本项目的文档变更后，运行同步脚本即可刷新 handbook 侧对应文档。
...
- group: `overview`
- file: `retail-insight-ai/README.md`
- self_sha256: `51340b3878b7fccbd5a7bdcdcbc2ed0f4c0bab07fae94fe85b1ddfd54eeca283`
- peers:
