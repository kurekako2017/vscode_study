-- ERIP Phase 2B PostgreSQL Schema snapshot for the Initial Alembic revision.
-- This file is immutable migration history; backend/db/schema.sql remains the latest schema.
