...
class ErrorCode(StrEnum):
    ...
    AI_RUNTIME_VERSION_CONFLICT = "ai_runtime_version_conflict"
    AI_RUNTIME_PROVIDER_NOT_READY = "ai_runtime_provider_not_ready"
    AI_RUNTIME_CONFIRMATION_REQUIRED = "ai_runtime_confirmation_required"
