...
- [21. Document Domain Model](#21-document-domain-model)
...
当前项目名称保持为 `Retail Insight AI`，本图册用于说明当前零售分析领域参考实现与未来企业平台目标之间的关系。
...
本图册中涉及平台化的结构和组件，若未在当前代码中实现，必须按目标架构或规划占位描述，不得写成当前已落地。
...
| Task | 任务 | タスク |
| Workflow | 工作流 | ワークフロー |
| Repository | 仓储层 / 仓储接口 | リポジトリ |
| Provider | 提供层 / 提供者 | プロバイダー |
...
- Repository Backend Switch Flow
- Data Import Flow
- Document Pipeline
- Audit Log Architecture
- Testing Matrix / Testing Flow
...
- Approval Workflow
- Database Target ER Diagram
- Testing Matrix
- Documentation Matrix

## Epic 12 Retrieval Diagram Set
...
## Phase 1 File Input Diagram Set
...
- Report status=generated -> Future Approval Workflow

## Phase 1.5 Diagram Set
...
## 22. Document Upload API Contract Freeze
...
## 23. Document Upload Workflow Freeze
...
## 24. Document Upload API MVP Implementation
...
## 27. Document Import Pipeline MVP
