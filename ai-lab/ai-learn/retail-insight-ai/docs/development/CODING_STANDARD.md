...
- Future sprint checklist items should include `Human-readable documentation is trilingual: English / 中文（简体） / 日本語` so the rule stays visible in every work session.
