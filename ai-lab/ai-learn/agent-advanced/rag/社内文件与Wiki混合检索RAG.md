...
- 适用场景：内部资料分散在文件服务器和 Wiki，用户只关心“答案是什么”和“出处在哪里”。
- 如果不用这种方式：员工要自己记住资料放在哪，或者被迫在多个系统里来回找，效率低且容易遗漏。
- 解决的问题：把多来源资料统一检索、统一过滤、统一引用，降低查找成本并提高答案可信度。
- 举例说明：例如问“请假和报销的最新规定是什么”，看 PDF 和 Wiki 两类来源能否一起参与回答。
...
- [agent-advanced/projects/advanced_rag_pipeline_demo](../projects/advanced_rag_pipeline_demo/README.md)
- [agent-advanced/projects/internal_hybrid_rag_demo](../projects/internal_hybrid_rag_demo/README.md)
...
3. 然后看 [agent-advanced/projects/advanced_rag_pipeline_demo](../projects/advanced_rag_pipeline_demo/README.md)
4. 最后跑 [agent-advanced/projects/internal_hybrid_rag_demo](../projects/internal_hybrid_rag_demo/README.md)
