...
python3 ai-learn/agent-lab/projects/structured_output_demo/main.py --mock "做一个读取 Markdown 的摘要工具"
# mock 模式运行 doc_qa_agent 并指定文档目录
python3 ai-learn/agent-lab/projects/doc_qa_agent/main.py --mock --docs ai-lab "这个目录主要讲什么？"
```
